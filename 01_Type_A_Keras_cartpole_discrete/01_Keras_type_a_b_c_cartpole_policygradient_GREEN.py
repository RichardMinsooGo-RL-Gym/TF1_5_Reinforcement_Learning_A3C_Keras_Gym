...
class RL_Agent:
    ...
    def loss_and_train(self):
        ...
        loss_total = actor_loss + entropy * 0.01
...
if __name__ == "__main__":
    ...
    if os.path.isfile("./save_model/Cartpole_Actor.h5"):
        global_agent.model.load_weights("./save_model/Cartpole_Actor.h5")
        print(" Actor restored!!")
    
    global_agent.run()
    
    # Save the trained model
    global_agent.model.save_weights("./save_model/Cartpole_Actor.h5")
