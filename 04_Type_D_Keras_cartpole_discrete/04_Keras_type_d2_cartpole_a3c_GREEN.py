...
class A3CAgent:
    ...
    def build_model(self):
        ...
        # critic 네트워크 생성
        critic = Sequential()
        critic.add(Dense(30, input_dim=self.state_size, activation='relu', kernel_initializer="he_uniform"))
...
class Worker(threading.Thread):
    ...
    def run(self):
        ...
        self.actor.save_weights("./save_model/Cartpole_Actor.h5")
        self.critic.save_weights("./save_model/Cartpole_Critic.h5")
