...
class A3CAgent:
    def __init__(self, state_size, action_size, env_name):
        ...
        if self.load_model:
            self.actor.load_weights("./save_model/Acrobot_Actor.h5")
            self.critic.load_weights("./save_model/Acrobot_Critic.h5")
    ...
    def train(self):
        # self.load_model('./save_model/Acrobot_a3c.h5')
...
class Worker(threading.Thread):
    ...
    def run(self):
        ...
        pylab.savefig("./save_graph/Acrobot_PG.png")
        self.actor.save_weights("./save_model/Acrobot_Actor.h5")
        self.critic.save_weights("./save_model/Acrobot_Critic.h5")
